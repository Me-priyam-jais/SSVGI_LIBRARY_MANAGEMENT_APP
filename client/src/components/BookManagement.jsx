          ...
          <div className="flex flex-col lg:flex-row space-y-0 space-x-0 lg:space-x-4">
            {isAuthenticated && user?.role === "Admin" && (
              <button
                ...
                className="relative pl-14 w-full sm:w-52 flex gap-4 justify-center items-center py-2 px-4 bg-black text-white rounded-md hover-bg-grey-800"
              >
            ...
            <table className="min-w-full border-collapse ">
              <thead>
                <tr className="bg-gray-200">
                  ...
                  <th className="px-4 py-2 text-left">Availbility</th>
                  {isAuthenticated && user?.role === "Admin" && (
