    ...
    <>
      <div className="fixed inset-0 bg-black bg-opacity-50 p-5 flex items-center justify-center z-50">
        <div className="w-full bg-white rounded-lg shadow-lg md:w-1/3">
          <div className="p-6">
            <header className="flex justify-between item-center mb-7 pb-5 border-b-[1px] border-black">
            ...
            <form onSubmit={handleAddNewAdmin}>
              ...
              <div className="mb-4">
                <label className="block text-grey-900 font-medium ">Name</label>
                <input
                  type="text"
                  value={name}
              ...
              <div className="mb-4">
                <label className="block text-grey-900 font-medium ">
                  Email
                </label>
                <input
                  type="email"
